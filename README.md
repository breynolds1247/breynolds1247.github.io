...
**Technical skills used in this project:** Machine learning (Convolutional Neural networks, Ensemble modeling, Decision trees, Random Forest, Voters), Transfer learning, Deep learning, Computer vision, Python (PyTorch, TensorFlow, SciKit-learn, Pandas, NumPy, Gradio)
